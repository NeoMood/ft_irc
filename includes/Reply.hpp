...
#define RPL_CHANNELMODEIS(chan, nick, mode, option)       ":irc_server 324 :" + nick + " MODE " + chan + " " + mode + " :" + option + "\r\n"

#define RPL_NOTOPIC             "331"
#define RPL_TOPIC(host, nick, chan) ":" + host + " 332 " + nick + " " + chan + " :\r\n"

#define RPL_NAMREPLY(host, nick, chan, users)  ":" + host + " 353 " + nick + " = " + chan + " :@" + users + "\r\n"
...
#define ERR_NOSUCHNICK(nick, user)  ":irc_server 401 " + nick + " " + user + " :No such nick/channel\r\n"
#define ERR_NOSUCHSERVER        "402"
#define ERR_NOSUCHCHANNEL(chan)   ":irc_server 403 " + chan + " :No such channel\r\n"
#define ERR_CANNOTSENDTOCHAN(nick, chan)    ":irc_server 404 " + nick + " " + chan + " :Cannot send to channel\r\n"
#define ERR_TOOMANYCHANNELS(nick, chan) ":irc_server 405 " + nick + " " + chan + " :You have joined too many channels\r\n"
...
#define ERR_UNKNOWNCOMMAND(cmd)      ":irc_server 421 " + cmd + " :Unknown command\r\n"
...
#define ERR_USERONCHANNEL(user, chan) ":irc_server 443 " + user + " " + chan + " :is already on channel\r\n"
...
#define ERR_KEYSET(chan) ":irc_server 467 " + chan + " :Channel key already set\r\n"
#define ERR_CHANNELISFULL(nick, chan)       ":irc_server 471" + nick + " " + chan + " :Cannot join channel (+l)\r\n"
#define ERR_UNKNOWNMODE(mode, chan)         ":irc_server 472 " + mode + " :is unknown mode char to me for " + chan + "\r\n"
#define ERR_INVITEONLYCHAN(nick, chan)      ":irc_server 473 " + nick + " " + chan + " :Cannot join channel (+i)\r\n"
#define ERR_BANNEDFROMCHAN(nick, chan)  "474 " + nick + " " + chan + " :Cannot join channel (+b)\r\n"
#define ERR_BADCHANNELKEY(nick, chan)         ":irc_server 475 " + nick + " " + chan + " :Cannot join channel (+k)\r\n"
#define ERR_BADCHANMASK(nick, chan)     ":irc_server 476 " + nick + " " + chan + " :Bad Channel Mask\r\n"
...
#define ERR_NOSUCHFILE(nick, filename) ":irc_server 991 " + nick + " " + filename + " :No such file\r\n"
#define ERR_INVALIDDATE(nick) "992 " + nick + " invalid date range\r\n"
#define RPL_LOGTIME(nick, reply) "993 " + nick + reply + "\r\n"
#define ERR_INVALIDKEYS(nick, reply) "994 " + nick + reply + "\r\n"